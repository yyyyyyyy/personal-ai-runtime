"""Tests for scheduler — timer registration and event dispatch."""
...
async def test_on_task_completed_starts_dependents(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("app.core.runtime.scheduler.kernel", k)
...
def test_shutdown_scheduler_stops_timer_engine(monkeypatch):
    ...
    from app.core.runtime.scheduler import shutdown_scheduler
